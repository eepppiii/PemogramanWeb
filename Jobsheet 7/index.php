...
<section class="hero-section">
  <div class="hero-content">
    ...
    <p class="hero-subtitle">
      Kelola divisi seni dan data keanggotaan organisasi dengan mudah, cepat, dan menyenangkan. 
      Semua data tersimpan rapi di satu tempat.
    </p>
    <div class="hero-actions">
      <a href="<?= baseUrl() ?>Seni/tambah.php" class="btn-primary">
        <span>➕</span> Tambah Divisi Seni
      </a>
      <a href="<?= baseUrl() ?>Anggota/tambah.php" class="btn-secondary">
